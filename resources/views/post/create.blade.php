                    ...
                    <form method="post" action="{{ route('post.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input placeholder="title"
                                class="w-full px-6 py-2 border rounded-lg text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="flex items-center my-2 ">
                            ...
                            <label for="isPublished" id="publishedLabel" class="ml-2 text-gray-700">Not Published</label>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea
                                class="form-textarea mt-1 block w-full border rounded-md py-2 px-3 placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                id="summary" name="summary" rows="3" placeholder="Enter a summary for your post"></textarea>
                        </div>
                          ...
                          <div class="col-lg-6 col-md-6 col-12">
                              <div class="form-group form">
                                  ...
                                  <!-- Various options in drop down menu to
                                      ...
                                      that we need -->
                                  <select class="mul-select w-full" multiple="true">
                      ...
                      <label class="block text-gray-700 font-bold mb-2" for="summary">content</label>
                            ...
                            <textarea id="editor"
                                class="form-textarea mt-1 block w-full border rounded-md py-2 px-3 placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                name="content" rows="3" placeholder="Enter a content for your post"></textarea>



                            <button
                                class="my-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-28 rounded focus:outline-none focus:shadow-outline"
                                type="submit">
                                Register
                            </button>
                    </form>
